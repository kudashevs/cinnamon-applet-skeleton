...
function YourProjectApplet(metadata, orientation, panel_height, instance_id) {
    this._init(metadata, orientation, panel_height, instance_id);
}

YourProjectApplet.prototype = {
    ...
    _set_update_interval: function () {
        ...
        this._timeout_id = Mainloop.timeout_add(this._update_interval, this._increment_count.bind(this));
    },
    ...
    _increment_count: function () {
        ...
        if (this._applet_running) {
            ...
            if (this._counter >= MAX_UPDATES) {
                this._applet_running = false;
            }

            // business logic
            this.set_applet_label(`updated ${this._counter} times`);
            this._counter < MAX_UPDATES && this._counter++;
